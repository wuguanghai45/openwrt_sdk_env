...
RUN wget https://downloads.openwrt.org/releases/24.10.0/targets/bcm27xx/bcm2710/openwrt-sdk-24.10.0-bcm27xx-bcm2710_gcc-13.3.0_musl.Linux-x86_64.tar.zst -O /bcm27xx_sdk.tar.zst && \
    mkdir -p /bcm27xx_sdk_extract && \
    zstd -d /bcm27xx_sdk.tar.zst -o /bcm27xx_sdk.tar && \
    tar xf /bcm27xx_sdk.tar -C /bcm27xx_sdk_extract && \
    mv /bcm27xx_sdk_extract/openwrt-sdk-24.10.0-bcm27xx-bcm2710_gcc-13.3.0_musl.Linux-x86_64 /bcm27xx-sdk && \
...
RUN wget https://downloads.openwrt.org/releases/24.10.0/targets/bcm27xx/bcm2710/openwrt-imagebuilder-24.10.0-bcm27xx-bcm2710.Linux-x86_64.tar.zst -O /bcm27xx_imagebuilder.tar.zst && \
    ...
    mv /bcm27xx_imagebuilder_extract/openwrt-imagebuilder-24.10.0-bcm27xx-bcm2710.Linux-x86_64 /bcm27xx-imagebuilder && \
